...
extension TTLPriorityLRUQueue {
    @discardableResult
    func unsafeSet(value: Value, for key: Key, priority: Double = .zero, expiredIn duration: TimeInterval = .infinity) -> Value? {
...
private extension TTLPriorityLRUQueue {
    func unsafeSetToTTLQueue(now: CPUTimeStamp, value: Value, for key: Key, priority: Double, expiredIn duration: TimeInterval) -> Value? {
        var res: Value? = nil
