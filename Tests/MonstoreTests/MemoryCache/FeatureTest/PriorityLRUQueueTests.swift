...
final class PriorityLRUQueueTests: XCTestCase {
    ...
    func testLRUStrategy() {
        ...
        XCTAssertEqual(
            queue.setElement(40, for: "key4"),
            20,
            "setElement should return evicted element when capacity is exceeded"
        )
    ...
    func testCapacityOverflow() {
        ...
        XCTAssertNil(queue.setElement(20, for: "key2"), "setElement should return nil for new key")
        XCTAssertEqual(
            queue.setElement(30, for: "key3"),
            10,
            "setElement should return evicted element when capacity is exceeded"
        )

        XCTAssertNil(
            queue.getElement(for: "key1"),
            "When capacity is exceeded, the least recently used entry ('key1') should be evicted."
        )
    ...
    func testEdgeCases() {
        ...
        XCTAssertEqual(
            queue.setElement(10, for: "key1"),
            10,
            "Inserting into a capacity-0 queue should return the element as it cannot be stored."
        )
    ...
    func testLRUEvictionOrder() {
        ...
        XCTAssertEqual(
            queue.getElement(for: "b"),
            2,
            "getElement should return the correct element"
        ) // b becomes most recently used
        XCTAssertEqual(
            queue.getElement(for: "a"),
            1,
            "getElement should return the correct element"
        ) // a becomes most recently used
        XCTAssertEqual(
            queue.getElement(for: "c"),
            3,
            "getElement should return the correct element"
    ...
    func testReturnElements() {
        ...
        XCTAssertEqual(
            queue.setElement(30, for: "key3"),
            10,
            "setElement should return evicted element when capacity exceeded"
        )
        ...
        XCTAssertEqual(
            queue.removeElement(for: "key2"),
            20,
            "removeElement should return correct element for existing key"
        )
    ...
    func testCapacityZeroReturnElements() {
        ...
        XCTAssertEqual(
            queue.setElement(10, for: "key1"),
            10,
            "setElement should return input element when capacity is 0"
        )
