...
final class CacheStatisticsTests: XCTestCase {
    ...
    func testMemoryUsage() {
        ...
        XCTAssertLessThan(statisticsArray.count * MemoryLayout<CacheStatistics>.size, 1_000_000)
    }
}
