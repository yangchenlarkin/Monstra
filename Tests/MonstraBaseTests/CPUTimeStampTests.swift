...
final class CPUTimeStampTests: XCTestCase {
    ...
    func testCPUTimeStampNow() {
        ...
        XCTAssertGreaterThanOrEqual(
            timestamp2.timeIntervalSinceCPUStart(),
            timestamp1.timeIntervalSinceCPUStart(),
    ...
    func testCPUTimeStampInfinity() {
        ...
        XCTAssertEqual(
            infinity.timeIntervalSinceCPUStart(),
            TimeInterval.infinity,
            "Infinity timestamp should have infinite seconds"
        )
    }
    ...
    func testCPUTimeStampSubtraction() {
        ...
        XCTAssertEqual(
            timestamp.timeIntervalSince(result),
            interval,
            accuracy: 0.001,
    ...
    func testCPUTimeStampWithZeroInterval() {
        ...
        XCTAssertEqual(
            timestamp2.timeIntervalSince(timestamp1),
            0.0,
            accuracy: 0.001,
            "Zero interval should work correctly"
        )
    }
    ...
    func testCPUTimeStampWithVeryLargeValues() {
        let timestamp1 = CPUTimeStamp.now()
        let veryLargeInterval: TimeInterval = 1_000_000.0 // 1 million seconds
    ...
    func testCPUTimeStampWithInfinity() {
        let timestamp1 = CPUTimeStamp.now()
        let infinityInterval = TimeInterval.infinity
    ...
    func testCPUTimeStampWithNaN() {
        let timestamp1 = CPUTimeStamp.now()
        let nanInterval = TimeInterval.nan
    ...
    func testCPUTimeStampWithMaxValues() {
        let timestamp1 = CPUTimeStamp.now()
        let maxInterval = TimeInterval.greatestFiniteMagnitude
        ...
        XCTAssertGreaterThan(
            timestamp2.timeIntervalSinceCPUStart(),
            timestamp1.timeIntervalSinceCPUStart(),
            "Maximum values should work correctly"
        )
    }
    ...
    func testCPUTimeStampWithMinValues() {
        ...
        XCTAssertLessThan(
            timestamp2.timeIntervalSinceCPUStart(),
            timestamp1.timeIntervalSinceCPUStart(),
            "Minimum values should work correctly"
        )
    }
    ...
    func testCPUTimeStampPrecision() {
        ...
        for interval in testValues {
            ...
            XCTAssertEqual(
                ...
                interval,
                accuracy: 0.000001,
                "Precision should be maintained for \(interval)"
            )
        }
    }
    ...
    func testCPUTimeStampPerformance() {
        ...
        measure {
            for _ in 0 ..< iterations {
                let timestamp = CPUTimeStamp.now()
                _ = timestamp.timeIntervalSinceCPUStart()
            }
        }
    }
